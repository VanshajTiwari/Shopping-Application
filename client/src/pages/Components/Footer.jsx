    ...
    <div className="max-w-[1050px]">
        ...
        <div>
            ...
            <div  className="text-gray-600 space-x-2 text-[13px]">
                    {interactLink.map((ele=><><a href="#"key={ele}>{ele}</a> | </>))}
            </div>
        </div>
